...
<form action="ukazka16zprac.php" method="post">
<table>
...
<tr><td><input type="checkbox" name="ch2" value="ch2"></td><td>Zaškrtávací 1</td></tr>
<tr><td><input type="checkbox" name="ch3" value="ch3"></td><td>Zaškrtávací 1</td></tr>

<input type="hidden" name="HID" value="80">
<tr><td><input type="reset" value="Obnovit"></td><td></td></tr>
<tr><td><input type="submit" value="Odeslat"></td><td></td></tr>
</table>
</form>
